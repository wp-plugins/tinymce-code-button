...
# main config
PLUGINSLUG="tinymce-code-button"
CURRENTDIR=`pwd`
MAINFILE="tinymce-code-element.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/tinymce-code-button/" # Remote SVN repo on wordpress.org, with no trailing slash
